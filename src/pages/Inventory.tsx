...
import { Refrigerator, Snowflake, Package, AlertTriangle, Trash2 } from 'lucide-react';
...
const categoryColors = {
  fridge: 'bg-blue-500/10 text-blue-600 border-blue-200',
  freezer: 'bg-cyan-500/10 text-cyan-600 border-cyan-200',
  pantry: 'bg-amber-500/10 text-amber-600 border-amber-200',
};

export default function Inventory() {
  const { t } = useTranslation();
  const { items, loading, expiringItems, deleteItem, markDepleted } = useInventory();
  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <main className="px-4 pt-6 space-y-6">
        ...
        {(['fridge', 'freezer', 'pantry'] as const).map(category => {
